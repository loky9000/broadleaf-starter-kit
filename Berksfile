...
cookbook "windows", git: "https://github.com/opscode-cookbooks/windows.git", ref: "v1.34.6"
...
cookbook 'cookbook-qubell-broadleaf', git: "https://github.com/qubell-bazaar/cookbook-qubell-broadleaf.git", ref: "v0.1.0"
