...
cookbook 'cookbook-qubell-build', git: "https://github.com/loky9000/cookbook-qubell-build.git"
cookbook 'cookbook-qubell-broadleaf', git: "https://github.com/loky9000/cookbook-qubell-broadleaf.git"
